...
int msj(int id)
{
    ...
    if(id<0)    //Si el id del mensaje es negativo se trata de un error
        printf("\a");   //Entonces hacemos un ruidito

    switch(id) /** Negativos para errores. -999 o no listados error generico o desconocido */
    {
        case 1:
            printf("\n Hecho!\n=========================================================\n\n");
            break;
        case 2:
            printf("\n\n\t   Adios!\n\n");
            break;
        case -1: // El archivo no existe
            printf("\n ERROR - El archivo no existe o no hay permisos suficientes para abrirlo\n");
            break;
        case -4: // Opcion no valida
            printf("\n ERROR - Opcion invalida (entre 1 y %d)\n=========================================================\n",QTY_OPCIONES);
            break;
        case -3: // Opcion no valida
            printf("\n No existe este ID\n");
            break;
        case -2:
            printf("\n ERROR - No hay ningun archivo abierto en modo lectura\n\n");
            break;
        case -999:
            printf("\n ERROR - Algo salio mal!\n\n");
            break;
        default: // Error desconocido o generico
            printf("\n ERROR - Algo salio mal!\n\n");
    }
    fflush(stdout);
    return 0;
